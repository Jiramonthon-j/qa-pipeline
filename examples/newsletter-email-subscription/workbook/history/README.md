...
| `v2-after-04-coverage-review-no-change.xlsx` | `coverage-review` (04) | **เหมือน v2 ทุกไบต์** — Skill 04 ตรวจพบ 2 ประเด็น (ดู `../../reports/04-coverage-review.md`) แต่ผู้ใช้เลือก Defer/Keep-as-is ทั้งคู่ จึงไม่มีการแก้ Workbook จริงรอบนี้ (พิสูจน์ได้ด้วยการ diff กับ v2 แล้วจะไม่ต่างกันเลย) |
...
| `v3-after-06-test-data-generator-no-change.xlsx` | `test-data-generator` (06) | **เหมือน v3 ทุกไบต์** — Skill 06 ผลิตแผน Mock Data เป็นไฟล์แยก (`../../reports/06-test-data.md`) เท่านั้น ไม่แตะ Workbook เลยตามการออกแบบ (ค่าจริงจะถูกใส่กลับตอน 06a) |
